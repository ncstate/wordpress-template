...
class acf_field_date_time_picker extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->version = '2.0.15';
		// $this->dir = plugin_dir_url( __FILE__ ); Override for correct CSS/JS paths
		$this->dir = '/wp-content/themes/ncstate-web-template/acf/date-time/';
		//$this->path = plugin_dir_path(__FILE__); Override for correct CSS/JS paths
		$this->path = '/wp-content/themes/ncstate-web-template/acf/date-time/';
